    ...
    return (
        <div className="bg-gray-800">
            <div className="max-w-4xl mx-auto p-6 bg-gray-800 text-white">
                {/* Header Section */}
                <div className="flex items-center mb-8 bg-gray-900 p-6 rounded-lg shadow-md bg-gray-900">
                    <img src={logo} alt={`${name} logo`} className="w-24 h-24 mr-6 rounded-full" />
                    <div className=''>
                        <h1 className="text-3xl font-bold ">{name}</h1>
                        <p className="text-xl ">{tagline}</p>
                        <p className="mt-2 ">{description}</p>
                        <p className="mt-1 ">Founded: {foundedYear} | Location: {location}</p>
                    </div>
                </div>
                ...
                <section className="mb-8">
                    ...
                    <div className="bg-gray-900 p-6 rounded-lg shadow-md">
                        ...
                        <div className="mb-4">
                            ...
                            <p className="text-white">{productDetails.targetAudience}</p>
                        </div>

                        {/* Product Demo Video */}
                        <div className="mb-4">
                            <h4 className="text-lg font-semibold">Product Demo Video:</h4>
                            <div className="mt-2">
                                <iframe
                ...
                <section className="mb-8">
                    ...
                    <div className="bg-gray-900 p-6 rounded-lg shadow-md space-y-8">
                        {/* Key Metrics */}
                        <div>
                        ...
                        {/* Active Customers */}
                        <div>
                            <h3 className="text-xl font-bold mb-4">Active Customers</h3>
                            <p className="text-white">{tractionMetrics.activeCustomers}+ active customers</p>
                        </div>
                ...
                <section className="mb-8">
                    ...
                    <div className="bg-gray-900 p-6 rounded-lg shadow-md space-y-8">
                        ...
                        <div>
                            ...
                            <p className="text-white">123 Startup Lane</p>
                            <p className="text-white">Innovation City, IN 12345</p>
                            <p className="text-white">Phone: (123) 456-7890</p>
                            <p className="text-white">Email: contact@startup.com</p>
                        </div>
